  ...
  return (
    <div className="flex flex-col px-5 lg:mb-44 mb-20">
      ...
      <div className="grid lg:grid-cols-3 grid-cols-2 lg:gap-5 gap-2">
        ...
        />
        <DevelopmentProspectsCard
          title="Учреждение центра методической поддержки допобразования"
          description="Большое внимание уделяется естественно-научным и техническим дисциплинам, открытие дополнительных секций и кружков, выдача грантов педагогам допобразования."
          classNameText="text-white"
